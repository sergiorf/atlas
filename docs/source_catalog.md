...
Receita CNPJ `Estabelecimentos` and the v0.3a company-data atomic silver workflow are implemented.
The company-data full May–July acceptance remains pending, so gold and public query support remain
deferred. The establishment input, acquisition, refresh,
